    ...
    <footer className="bg-gray-900 mt-4 flex flex-col items-center py-8">
      <div className="container flex flex-col items-center justify-center gap-8 md:flex-row">
        <div className="flex flex-col items-center md:flex-row md:items-center gap-4">
          <div className="logo w-16 h-16 md:w-25 md:h-25">
            <img src={logo} alt="StudyHive" className="w-full h-auto" />
          </div>
          <h2 className="text-[20px] text-customYellow font-bold mt-4 md:mt-0 md:ml-4 text-center md:text-left">
            Your All in One Platform for<br />
      ...
      <div className="container flex flex-col items-center justify-center gap-4 mt-4 md:flex-row">
        <p className="text-white text-lg text-center md:text-left">Subscribe to get our Newsletter</p>
        <div className="flex flex-col items-center justify-center gap-4 md:flex-row">
          <input 
            type="email" 
            placeholder="Enter your email" 
            className="bg-gray-800 text-white py-2 px-4 rounded-lg mt-2 md:mt-0" 
          />
          <button 
            className="bg-custom-color text-white hover:bg-white hover:text-customGray py-2 px-4 rounded-[80px] mt-2 md:mt-0 md:ml-4">
            Subscribe
          </button>
        </div>
      </div>
      <div className="container flex flex-col items-center justify-center gap-4 mt-8 md:flex-row">
        <p className="text-white text-lg text-center md:text-left">Follow Us</p>
        <div className="flex items-center justify-center gap-4">
          <a href="#" className="text-white hover:text-customYellow">
            <i className="fab fa-facebook-f"></i>
      ...
      <div className="mt-5">
          <p className="text-white text-center md:text-left">© 2024 StudyHive. All Rights Reserved</p>
        </div>
    </footer>
  );
};
